...
We carried out a Gene Ontology (GO) \[12\] and REACTOME \[13\] functional enrichment analysis of these genes with the complete set of genes in the expression matrix as background. For this, we employed `FunEnrich` and focused on the 5 most enriched GO terms and REACTOME pathways (**GOAL 3**).
